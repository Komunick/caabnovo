...
| Notícias e mídia editorial              | Planejado; implementação em branch separada, fora deste PR     | Comunicação → Conteúdo e destaques.                            | Autoria, versões, prévia, publicação, vigência e distribuição. Arquivos reutilizam a fundação.                                                   |
