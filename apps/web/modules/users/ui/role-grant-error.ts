const messages: Record<string, string> = {
  ...
  ROLE_ALREADY_ASSIGNED: "Este usuário já possui esta função. Atualize a página para conferir.",
  USER_NOT_FOUND: "O usuário não foi encontrado ou está desativado.",
